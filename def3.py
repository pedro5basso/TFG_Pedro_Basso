...
class Main(tk.Frame):
    ...
    def AskDirectories(self):
        ...
        try:
            ...
            self.URL_GT =  'C:/Users/Pedro/Desktop/TFG/Dades 16/gt'
            ...
            self.URL_GT_TESTSET_DGT = self.URL_GT + '/testset/dGT/'
            self.URL_GT_TESTSET_RGT = self.URL_GT + '/testset/rGT/'
            self.URL_XML = 'C:/Users/Pedro/Desktop/TFG/Dades 16/gt/all_topics.xml'
            self.ALL_TOPICS_FILE = '/all_topics.txt'
            self.URL_TXT_FILE = self.URL_GT + self.ALL_TOPICS_FILE
    ...
    def CheckResultwindow(self):
        ...
        if(file_txt_name != ''):          
            ...
            self.new.geometry(str(screen_width+100) + 'x' + str(screen_height))
            self.new.grid()
            MetricWindow(self.new,file_txt_name,root.filename,self.URL_IMAGES ,self.URL_D3_FILES ,self.URL_GT)
        else:
            print('Choose a folder!')
    ...
    def CheckClustersWindow(self):
        ...
        ClusterRepresentation(file_txt_name,root.filename,self.URL_IMAGES ,self.URL_D3_FILES ,self.URL_GT)
...
class ClusterRepresentation():
    ...
    def __init__(self,file_txt_name,filename_path,URL_IMAGES ,URL_D3_FILES ,URL_GT):
